        ...
        <div className="flex items-center justify-start gap-1.5">
          ...
          <div className="flex items-center gap-1 transition-opacity duration-150 opacity-0 group-hover:opacity-100 focus-within:opacity-100 pointer-coarse:opacity-100">
            <button
              ...
              aria-label={`Edit ${holding.symbol.replace(/-USD$/, '')}`}
            ...
            <button
              ...
              aria-label={`Delete ${holding.symbol.replace(/-USD$/, '')}`}
      ...
      <td className="py-2 pl-3 pr-2">
        <div className="flex items-center justify-start gap-1.5">
          ...
          <button
            ...
            aria-label={`${expanded ? 'Collapse' : 'Expand'} ${holding.symbol.replace(/-USD$/, '')} lots`}
